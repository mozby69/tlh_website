<?php
/**
 * FILE PURPOSE: Admin UI for creating, downloading, and deleting protected SQL backups. The route uses database-export.php so Apache backup-file protections do not block the UI.
          ...
          <tr>
            ...
            <td data-label="Actions">
              <div class="admin-actions database-backup-actions">
                <a class="btn btn-outline btn-sm" href="database-export.php?download=<?= rawurlencode($backup['filename']) ?>">Download</a>
